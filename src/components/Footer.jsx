...
const addressList = [
  { iconName: "icofont-google-map", text: " Monofia, Ashmoun, Egypt." },
  { iconName: "icofont-phone", text: " +20 1555261868" },
  { iconName: "icofont-envelope", text: " ahmedashraf12777@gamil.com" },
];
...
const Footer = () => {
  return (
    <footer className="style-2">
        <div className="footer-top dark-view ">
    ...
    <div className="footer-bottom">
        <div className="container">
            <div className='section-wrapper'>
                <p>&copy; 2024 <Link to="/">Shop Cart</Link> Designed by <a href="/" target='_blank'>Ahmed Ashraf ❤</a></p>
                <div className="footer-bottom-list">
                    {
                        footerbottomList.map((val, i) => (
                            <a key={i} href="#">{val.text}</a>
                        ))
                    }
                </div>                       
            </div>
